...
import { idlFactory } from './learnify_ai_frontend.did.js';
export { idlFactory } from './learnify_ai_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LEARNIFY_AI_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./learnify_ai_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the learnify_ai_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./learnify_ai_frontend.did.js")._SERVICE>}
 */
export const learnify_ai_frontend = createActor(canisterId);
